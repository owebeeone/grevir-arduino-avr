...
add_library(grevir_arduino_avr_compile OBJECT native_compile.cpp ${header_sources})
target_link_libraries(grevir_arduino_avr_compile PRIVATE grevir::arduino_avr)
...
add_custom_target(grevir_arduino_avr_claim_checks ALL
  ...
  COMMENT "Checking Arduino AVR timer reservations"
  VERBATIM)
